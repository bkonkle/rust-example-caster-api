...
#[tokio::test]
async fn test_profiles_service_get_model() -> Result<()> {
    ...
    let result = service.get_model(&profile.id, &false).await?;
    ...
    assert_eq!(result, Some((profile, None)));
...
#[tokio::test]
async fn test_profiles_service_get_model_with_related() -> Result<()> {
    let user = users_factory::create_user("test-username");
    ...
    let result = service.get_model(&profile.id, &true).await?;
    ...
    assert_eq!(result, Some((profile, Some(user))));
...
#[tokio::test]
async fn test_profiles_service_update_model() -> Result<()> {
    let user = users_factory::create_user("test-username");
    let profile = users_factory::create_profile_for_user("test@profile.com", user.clone());
...
#[tokio::test]
async fn test_profiles_service_update_model_with_related() -> Result<()> {
    let user = users_factory::create_user("test-username");
    let profile = users_factory::create_profile_for_user("test@profile.com", user.clone());
