...
async fn test_profiles_service_create() -> Result<()> {
    ...
    assert_eq!(
        ...
        vec![Transaction::from_sql_and_values(
            DatabaseBackend::Postgres,
            r#"INSERT INTO "profiles" ("email", "display_name", "picture", "city", "state_province", "user_id") VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING "id", "created_at", "updated_at", "email", "display_name", "picture", "city", "state_province", "user_id""#,
            vec![
                profile.email.into(),
